...
// Current location  "http:localhost:3001/api/guardian"

router.get('/', async (req,res) => {
try {
const guardianData = await Guardian.findAll({include:[{model:Student,   attributes:{exclude:["inProgessGrade","teacherId","attendanceId", "behaviorId","communicationId","assignmentFeedbackId"]}}]});
